  ...
  return (
    <div >
        ...
        <div className='flex flex-col items-center justify-center text-sm lg:flex-row absolute inset-x-0 bottom-[10%]'>
            <button className='bg-[#393c41] rounded w-72 lg:w64 lg:mx-4 h-10 mt-2 text-white'>Custom Order</button><button className='bg-[#f4f4f4] rounded w-72 lg:w64 lg:mx-4 h-10 mt-2'>Demo Drive</button>
        </div>
