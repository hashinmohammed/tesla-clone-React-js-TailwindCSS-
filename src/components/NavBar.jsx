...
function NavBar() {
  return (
    <div className='z-50 fixed top-0 flex justify-between items-center px-12 p-4 text-sm font-bold'>
        ...
        <div className='hidden lg:inline'>
            <ul  className='flex justify-center hover:cursor-pointer ml-44'>
        ...
        <div className='hidden lg:inline'>
            <ul className='flex justify-center hover:cursor-pointer ml-48'>
